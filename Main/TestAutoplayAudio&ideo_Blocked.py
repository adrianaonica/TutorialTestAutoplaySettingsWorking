...
#blockvideo and audio
editConfigTxtBox.send_keys("5")
...
timeOfScreenshot = datetime.now()
timeOfScreenshot.isoformat()
driver.save_screenshot("/Users/865419/PycharmProjects/TutorialTestAutoplaySettingsWorking/BlockedAudio&Video.png -"+timeOfScreenshot.isoformat()+".png")
driver.quit()